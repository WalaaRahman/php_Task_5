...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $errors = [];
      ...
      }elseif(!validate($password,'size',6,10) ){
          $errors['Password'] = "Password Length Must >= 6 ch & <= 10";
      }
    ...
    # Validate extension type
            ...
            if(in_array($typeArray[1],$allowedEx)){
                ...
                $desPath='./uploads/'.$fileName; // creating destination path --> uploades folder
      ...
      if(count($errors) > 0){
          ...
          # File..........
    $file=fopen('form.txt','a') or die('error opening file');


    $txt=$name." , ".$email." , ".$password." , ".$fileName." , ".$gender." , ".$linkedIn."\n";
    fwrite($file,$txt);
    fclose($file);
